...
SIGNAL_NAME = 'nigec_signalsell_RSI'
...
def do_work():
    ...
    while True:
        try:
            ...
            print(f'{SIGNAL_NAME} Signals RSI: {len(signal_coins)} coins with Sell Signals. Waiting {TIME_TO_WAIT} minutes for next analysis.')
            time.sleep((TIME_TO_WAIT*60))
        except Exception as e:
