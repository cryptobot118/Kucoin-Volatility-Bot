...
def load_correct_creds(creds):
    try:
        ...
        return creds['prod']['access_key'], creds['prod']['secret_key'], creds['prod']['passphrase_key']
...
def test_api_key(client, KucoinAPIException):
    ...
    try:
        ...
        if e.code in  [400001,400003,400004,400006]:
